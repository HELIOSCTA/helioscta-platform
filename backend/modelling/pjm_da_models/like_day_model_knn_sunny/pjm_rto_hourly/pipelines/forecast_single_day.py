"""Compatibility wrapper for the PJM-backed KNN Sunny tomorrow pipeline."""
...
if __package__ in (None, ""):
    ...
    from backend.modelling.pjm_da_models.like_day_model_knn_sunny.pjm_rto_hourly.pipelines.forecast_tomorrow import (  # type: ignore[import-not-found]
        run,
    )
else:
