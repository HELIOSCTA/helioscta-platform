"""Manual backfill runner for CAISO day-ahead hourly LMPs."""
...
from backend.orchestration.power.caiso import da_lmps as workflow
...
def main(
    ...
    """Replay CAISO DA hourly LMPs with orchestration and idempotent upserts."""
