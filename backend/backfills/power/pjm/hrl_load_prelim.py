"""Manual backfill runner for PJM hourly preliminary load."""
...
from backend.scrapes.power.pjm import hrl_load_prelim as source
...
def main(
    ...
    """Replay PJM hourly preliminary load with production upsert semantics."""
