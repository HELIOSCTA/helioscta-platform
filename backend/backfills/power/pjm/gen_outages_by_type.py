"""Manual backfill runner for PJM generation outages by type."""
...
from backend.scrapes.power.pjm import gen_outages_by_type as source
...
def main(
    ...
    """Replay daily outage forecast executions with production upsert semantics."""
    ...
    while current <= end:
        frame = source.main(
            ...
            metadata=backfill_metadata(
                ...
                extra={"backfill_execution_date": current.isoformat()},
            ),
        )
