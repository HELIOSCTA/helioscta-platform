"""Manual backfill runner for PJM hourly metered load."""
...
from backend.scrapes.power.pjm import hrl_load_metered as source
...
def main(
    ...
    """Replay PJM hourly metered load with production upsert semantics."""
