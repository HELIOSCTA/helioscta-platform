"""Manual backfill runner for PJM unverified hourly RT LMPs."""
...
from backend.scrapes.power.pjm import rt_unverified_hrl_lmps as source
...
DEFAULT_MAX_DAYS = 30
DEFAULT_PRICING_NODE_TYPES = source.DEFAULT_PRICING_NODE_TYPES
...
def main(
    ...
    """Replay unverified hourly RT LMPs with production upsert semantics."""
