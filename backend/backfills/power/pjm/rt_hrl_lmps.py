"""Manual backfill runner for PJM verified hourly RT LMPs."""
...
from backend.scrapes.power.pjm import rt_hrl_lmps as source
...
def main(
    ...
    """Replay verified hourly RT hub LMPs with production upsert semantics."""
