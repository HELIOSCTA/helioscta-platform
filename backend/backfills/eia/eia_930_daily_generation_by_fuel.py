"""Manual backfill runner for EIA-930 daily generation by fuel type."""
...
from backend.orchestration.eia import eia_930_daily_generation_by_fuel as workflow
...
def main(
    ...
    """Replay EIA-930 daily generation with idempotent upserts."""
