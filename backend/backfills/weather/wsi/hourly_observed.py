"""Manual backfill runner for WSI hourly observed weather."""
...
from backend.orchestration.weather.wsi import hourly_observed as source
...
def main(
    ...
    """Replay WSI hourly observed weather with production upsert semantics."""
