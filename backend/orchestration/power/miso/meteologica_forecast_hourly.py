"""Orchestrate MISO Meteologica hourly forecast refreshes."""
...
from backend.scrapes.power.miso import meteologica_forecast_hourly as scrape
...
DATASET_NAME = "miso_meteologica_forecast_hourly"
...
def main(
    *,
    ...
    """Run MISO Meteologica forecast refreshes and emit freshness events."""
