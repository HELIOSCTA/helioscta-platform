"""Orchestrate MISO final real-time hourly LMPs."""
...
from backend.scrapes.power.miso import rt_lmps_final as scrape
...
DATASET_NAME = "miso_rt_lmps_final"
...
def main(
    ...
    """Run the MISO RT final LMP workflow and emit readiness events."""
