"""Orchestrate SPP preliminary real-time five-minute LMPs."""
...
from backend.scrapes.power.spp import rt_lmps_prelim as scrape
...
DATASET_NAME = "spp_rt_lmps_prelim"
DATA_SCOPE = "hubs_spp_north_south"
DATA_GRAIN = "operating_date_five_minute_node"
INTERVAL_MINUTES = 5
...
POLL_CEILING_SECONDS = int(4.5 * 60 * 60)
...
def main(
    ...
    """Run the SPP RT preliminary LMP workflow and emit readiness events."""
