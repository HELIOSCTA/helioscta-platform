"""Orchestrate SPP Meteologica hourly forecast refreshes."""
...
from backend.scrapes.power.spp import meteologica_forecast_hourly as scrape
...
DATASET_NAME = "spp_meteologica_forecast_hourly"
...
def main(
    *,
    ...
    """Run SPP Meteologica forecast refreshes and emit freshness events."""
