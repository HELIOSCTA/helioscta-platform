"""Orchestrate NYISO Meteologica hourly forecast refreshes."""
...
from backend.scrapes.power.nyiso import meteologica_forecast_hourly as scrape
...
DATASET_NAME = "nyiso_meteologica_forecast_hourly"
...
def main(
    *,
    ...
    """Run NYISO Meteologica forecast refreshes and emit freshness events."""
