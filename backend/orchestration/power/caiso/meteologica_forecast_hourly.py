"""Orchestrate CAISO Meteologica hourly forecast refreshes."""
...
from backend.scrapes.power.caiso import meteologica_forecast_hourly as scrape
...
DATASET_NAME = "caiso_meteologica_forecast_hourly"
...
def main(
    *,
    ...
    """Run CAISO Meteologica forecast refreshes and emit freshness events."""
