"""Orchestrate CAISO real-time five-minute LMPs."""
...
from backend.scrapes.power.caiso import rt_lmps as scrape
...
DATASET_NAME = "caiso_rt_lmps"
DATA_SCOPE = "trading_hubs_np15_sp15"
DATA_GRAIN = "trading_date_five_minute_node"
INTERVAL_MINUTES = 5
...
def main(
    ...
    """Run the CAISO RT five-minute LMP workflow and emit readiness events."""
    ...
    try:
        ...
        if events:
            ...
            run_logger.info(
                "No complete CAISO RT LMP trading date detected; "
