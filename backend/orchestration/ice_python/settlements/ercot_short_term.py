"""Orchestrate ERCOT short-term ICE settlement and contract-date pulls."""
...
API_SCRAPE_NAME = "orchestration_ice_python_settlements_ercot_short_term"
...
def run(
    ...
    """Run the ERCOT short-term settlement scrape with retry policy."""
    selected_symbols = ercot.get_symbols(symbols=symbols)
    ...
    def operation(log_file_path: Path | None) -> dict[str, object]:
        ...
        return registry.run_registry_settlements(
            ...
            registry_label="ercot_short_term",
