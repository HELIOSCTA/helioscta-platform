"""Orchestrate eastern gas futures ICE settlement and contract-date pulls."""
...
API_SCRAPE_NAME = "orchestration_ice_python_settlements_gas_futures_east"
REGISTRY_LABEL = "gas_futures_east"
PRODUCTS = ["ALQ", "TMT", "T5B", "IZB", "TZS", "DOM"]
...
def run(
    ...
    """Run the eastern gas basis futures settlement scrape."""
