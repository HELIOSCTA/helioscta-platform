"""Orchestrate western gas futures ICE settlement and contract-date pulls."""
...
API_SCRAPE_NAME = "orchestration_ice_python_settlements_gas_futures_west"
REGISTRY_LABEL = "gas_futures_west"
PRODUCTS = ["WAH", "NTO", "SCB", "PGE", "CRI"]
...
def run(
    ...
    """Run the western gas basis futures settlement scrape."""
