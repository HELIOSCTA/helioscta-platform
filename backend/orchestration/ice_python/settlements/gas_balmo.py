"""Orchestrate gas BALMO ICE settlement and contract-date pulls."""
...
def run(
    ...
    """Run the gas BALMO settlement scrape with retry policy."""
    selected_symbols = symbols or gas.get_balmo_gas_symbol_codes()
    ...
    def operation(log_file_path: Path | None) -> dict[str, object]:
        logger.info(
            ...
            "default BALMO gas" if symbols is None else len(symbols),
