"""Orchestrate eastern power daily ICE settlement and contract-date pulls."""
...
API_SCRAPE_NAME = "orchestration_ice_python_settlements_east_power_daily"
...
def run(
    ...
    """Run the eastern power daily settlement scrape with retry policy."""
    selected_symbols = east_power.get_daily_symbols(symbols=symbols)
    ...
    def operation(log_file_path: Path | None) -> dict[str, object]:
        logger.info(
            ...
            "default eastern power daily" if symbols is None else len(symbols),
        ...
        return registry.run_registry_settlements(
            ...
            registry_label="east_power_daily",
