"""Orchestrate Gulf gas futures ICE settlement and contract-date pulls."""
...
API_SCRAPE_NAME = "orchestration_ice_python_settlements_gas_futures_gulf"
REGISTRY_LABEL = "gas_futures_gulf"
PRODUCTS = ["TRZ", "TFL", "CGB", "CGM", "TWB", "HXS"]
...
def run(
    ...
    """Run the Gulf gas basis futures settlement scrape."""
