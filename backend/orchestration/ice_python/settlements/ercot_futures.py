"""Orchestrate ERCOT futures ICE settlement and contract-date pulls."""
...
API_SCRAPE_NAME = "orchestration_ice_python_settlements_ercot_futures"
...
def run(
    ...
    """Run the bounded ERCOT futures settlement scrape with retry policy."""
    futures_symbols = ercot.get_futures_symbols_for_horizon(
        products=products,
    ...
    def operation(log_file_path: Path | None) -> dict[str, object]:
        logger.info(
            ...
            "default ERCOT futures products" if products is None else products,
            futures_start_date,
            months_forward,
