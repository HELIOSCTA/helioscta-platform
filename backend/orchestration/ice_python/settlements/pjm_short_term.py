"""Orchestrate PJM short-term ICE settlement and contract-date pulls."""
...
API_SCRAPE_NAME = "orchestration_ice_python_settlements_pjm_short_term"
...
def run(
    ...
    """Run the PJM short-term settlement scrape with retry policy."""
    ...
    def operation(log_file_path: Path | None) -> dict[str, object]:
        logger.info(
            ...
            "default PJM short-term" if symbols is None else len(symbols),
