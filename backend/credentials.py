...
SLACK_POSITIONS_TRADES_ALERTS_CHANNEL_ID = _get_first_env(
    "SLACK_POSITIONS_TRADES_ALERTS_CHANNEL_ID"
)
SLACK_POSITIONS_TRADES_ALERTS_CHANNEL_NAME = _get_first_env(
    "SLACK_POSITIONS_TRADES_ALERTS_CHANNEL_NAME",
    default="#helios-alerts-positions-trades",
)
...
CLEAR_STREET_SFTP_REMOTE_DIR = os.getenv("CLEAR_STREET_SFTP_REMOTE_DIR") or r'/'
...
MUFG_SFTP_REMOTE_DIR = os.getenv("MUFG_SFTP_REMOTE_DIR") or r'/'
