...
-- cs_v3_80_mufg_latest, without narrowing to the latest Clear Street upload.
...
select *
from FINAL
),  __dbt__cte__cs_v3_65_eod_all_history as (
...
order by
    ...
    select * from __dbt__cte__cs_v3_65_eod_all_history
),
