"""CAISO real-time five-minute LMPs for NP15 and SP15 trading hubs.
...
- Market/process: RTM
- Grain: trading date x five-minute interval x pricing node
...
API_SCRAPE_NAME = "rt_lmps"
OASIS_QUERY_NAME = "PRC_INTVL_LMP"
OASIS_VERSION = 2
MARKET_RUN_ID = "RTM"
...
def _pull(
    *,
    ...
    """Pull CAISO real-time five-minute LMPs for one Pacific trading date."""
...
def main(
    ...
    """Run the CAISO real-time five-minute LMP scrape."""
