"""MISO preliminary real-time hourly LMPs."""
...
API_SCRAPE_NAME = "miso_rt_lmps_prelim"
...
def _pull(
    *,
    ...
    """Pull MISO preliminary real-time hourly LMPs for one operating date."""
...
def main(
    ...
    """Run the MISO preliminary real-time hourly LMP scrape."""
