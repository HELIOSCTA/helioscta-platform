"""SPP day-ahead hourly LMPs for ICE-traded SPP hubs."""
...
ENDPOINT_TEMPLATE = (
    ...
    "?path=/{operating_year}/{operating_month}/By_Day/"
    "DA-LMP-SL-{operating_date_compact}0100.csv"
)
...
def _pull(
    *,
    ...
    """Pull SPP day-ahead hourly LMPs for one Central operating date."""
    ...
    return _lmp.pull_lmps(
        ...
        portal_paths=(_lmp.da_portal_path(business_date),),
...
def main(
    ...
    """Run the SPP day-ahead hourly LMP scrape."""
