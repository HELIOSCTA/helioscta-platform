"""ERCOT hourly load, solar, and wind forecasts from Meteologica."""
...
FEEDS: tuple[MeteologicaForecastFeed, ...] = (
    MeteologicaForecastFeed(
        1943,
        "USA ERCOT power demand forecast Meteologica hourly",
        METRIC_LOAD,
        "ERCOT",
        "ERCOT",
        "usa_ercot_power_demand_forecast_hourly",
    ),
    MeteologicaForecastFeed(
        1840,
        "USA ERCOT photovoltaic power generation forecast Meteologica hourly",
        METRIC_SOLAR,
        "ERCOT",
        "ERCOT",
        "usa_ercot_pv_power_generation_forecast_hourly",
    ),
    MeteologicaForecastFeed(
        1877,
        "USA ERCOT wind power generation forecast Meteologica hourly",
        METRIC_WIND,
        "ERCOT",
        "ERCOT",
        "usa_ercot_wind_power_generation_forecast_hourly",
    ),
    MeteologicaForecastFeed(
        1952,
        "USA ERCOT Houston ForecastZone power demand forecast Meteologica hourly",
        METRIC_LOAD,
        "ERCOT",
        "HOUSTON_FORECAST_ZONE",
        "usa_ercot_houston_forecastzone_power_demand_forecast_hourly",
    ),
    MeteologicaForecastFeed(
        1954,
        "USA ERCOT North ForecastZone power demand forecast Meteologica hourly",
        METRIC_LOAD,
        "ERCOT",
        "NORTH_FORECAST_ZONE",
        "usa_ercot_north_forecastzone_power_demand_forecast_hourly",
    ),
    MeteologicaForecastFeed(
        1953,
        "USA ERCOT South ForecastZone power demand forecast Meteologica hourly",
        METRIC_LOAD,
        "ERCOT",
        "SOUTH_FORECAST_ZONE",
        "usa_ercot_south_forecastzone_power_demand_forecast_hourly",
    ),
    MeteologicaForecastFeed(
        1955,
        "USA ERCOT West ForecastZone power demand forecast Meteologica hourly",
        METRIC_LOAD,
        "ERCOT",
        "WEST_FORECAST_ZONE",
        "usa_ercot_west_forecastzone_power_demand_forecast_hourly",
    ),
)
