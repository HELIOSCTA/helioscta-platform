"""ISO-NE Hourly System Demand.

Source definition:
https://www.iso-ne.com/isoexpress/web/reports/load-and-demand

Feed metadata reviewed from ISO-NE ISO Express on 2026-06-13:
- Feed short name: hourly_system_demand
- Display name: Real-Time Hourly System Load Report
- Category: Load and Demand
- Description: Hourly actual total system load in MW.
- Posting frequency: Hourly/daily CSV reports.
"""
...
def _build_url(start_date: datetime, end_date: datetime) -> str:
    endpoint = (
        "transform/csv/hourlysystemdemand?"
...
def _pull(
    *,
    ...
    """Pull ISO-NE hourly system demand for one operating date."""
...
def main(
    ...
    """Run the ISO-NE hourly system demand scrape."""
