...
# Region metadata uses EIA Lower 48 natural gas storage regions.
NEXT_DAY_GAS_PRODUCTS: list[tuple[str, str | None, str, str]] = [
    ("XGF", "1156", "Henry Physical Fixed Price Spot", "south_central"),
    ("XVA", "3306646", "Transco Station 85 (Zone 4) Physical Fixed Price Spot", "south_central"),
    ("XLM", "1318", "TGP 500L Physical Fixed Price Spot", "south_central"),
    ("YHV", "69138045", "Florida Gas Zone 3 Physical Fixed Price Spot", "east"),
    ("XLA", "1306", "CG Mainline Physical Fixed Price Spot", "south_central"),
    ("XTA", "3306641", "ANR SE (Louisiana) Physical Fixed Price Spot", "south_central"),
    ("YV7", "72764821", "Pine Prairie Physical Fixed Price Spot", "south_central"),
    ("XVM", "3306648", "TETCO WLA Physical Fixed Price Spot", "south_central"),
    ("XYZ", "3306663", "HSC HPL Pool Physical Fixed Price Spot", "south_central"),
    ("XT6", "34598274", "Waha Physical Fixed Price Spot", "south_central"),
    ("XIT", "1162", "NGPL TXOK Physical Fixed Price Spot", "south_central"),
    ("X7F", None, "Algonquin Citygates (non-G)", "east"),
    ("XZR", "26209306", "TETCO M3 Physical Fixed Price Spot", "east"),
    ("YFF", "60045058", "Transco Z5 South Physical Fixed Price Spot", "east"),
    ("Z2Y", None, "Transco Zone 5 North", "east"),
    ("YP8", None, "Iroquois Zone 2", "east"),
    ("XWK", "26209312", "Transco Z6 (NY) Physical Fixed Price Spot", "east"),
    ("XJL", "1155", "Eastern Gas-South Physical Fixed Price Spot", "east"),
    ("XIZ", "1161", "TCO Physical Fixed Price Spot", "east"),
    ("YAG", "42944123", "TETCO M2 (Receipt) Physical Fixed Price Spot", "east"),
    ("Z1Q", None, "Tennessee Z4 (Marcellus)", "east"),
    ("YQE", "70466407", "Leidy-Transco Physical Fixed Price Spot", "east"),
    ("XTG", "3306642", "NNG Ventura Physical Fixed Price Spot", "midwest"),
    ("YHF", "65657575", "NGPL Nicor Physical Fixed Price Spot", "midwest"),
    ("XKF", "3306638", "Socal Citygate Physical Fixed Price Spot", "pacific"),
    ("XGV", "1160", "PG&E Citygate Physical Fixed Price Spot", "pacific"),
    ("YKL", None, "CIG Mainline", "mountain"),
    ("XJR", "1158", "NGPL Midcont Physical Fixed Price Spot", "south_central"),
...
BALMO_GAS_PRODUCTS: list[tuple[str, str, str, str]] = [
    ("HHD", "6590229", "Henry Swing Future", "south_central"),
    ("TRW", "6590252", "Transco Station 85 (Zone 4) Swing Future", "south_central"),
    ("FTS", "6590228", "Florida Gas Zone 3 Swing Future", "east"),
    ("CGR", "6590221", "CG-Mainline Swing Future", "south_central"),
    ("APS", "6590219", "ANR SE (Louisiana) Swing Future", "south_central"),
    ("CVK", "71544009", "Pine Prairie Swing Future", "south_central"),
    ("CVP", "71544034", "TETCO WLA Swing Future", "south_central"),
    ("UCS", "6590255", "HSC Swing Future", "south_central"),
    ("WAS", "6590256", "Waha Swing Future", "south_central"),
    ("NTS", "6590236", "NGPL TXOK Swing Future", "south_central"),
    ("ALS", "6590217", "Algonquin Citygates Swing Future", "east"),
    ("TSS", "6590253", "TETCO M3 Swing Future", "east"),
    ("DKS", "42944092", "Transco Zone 5 Swing Future", "east"),
    ("T5C", "82270890", "Transco Zone 5 South Swing Future", "east"),
    ("IZS", "21592921", "Iroquois-Z2 Swing (Platts) Future", "east"),
    ("ZSS", "6590257", "Transco Zone 6 (NY) Swing Future", "east"),
    ("DSS", "6590227", "Eastern Gas South Swing Future", "east"),
    ("SCS", "6590244", "Socal Citygate Swing Future", "pacific"),
    ("PIG", "6590241", "PG&E Citygate Swing Future", "pacific"),
    ("CRS", "6590223", "CIG Rockies Swing Future", "mountain"),
    ("MTS", "6590232", "NGPL Midcont Swing Future", "south_central"),
...
GAS_FUTURES_PRODUCTS: list[dict] = [
    {"product": "HNG", "ice_product_id": "6590258", "product_name": "Henry LD1 Fixed Price Future", "description": "Henry Hub Natural Gas", "region": "south_central"},
    ...
    {"product": "PHH", "ice_product_id": "6590264", "product_name": "Henry Penultimate Fixed Price Future", "description": "Henry Penultimate Natural Gas", "region": "south_central"},
    {"product": "TRZ", "ice_product_id": "6590165", "product_name": "Transco Station 85 (Zone 4) Basis Future", "description": "Transco Station 85 Basis", "region": "south_central"},
    {"product": "TFL", "ice_product_id": "6590159", "product_name": "Tennessee 500L Basis Future", "description": "TGP 500L Basis", "region": "south_central"},
    {"product": "CGB", "ice_product_id": "6590126", "product_name": "CG-Mainline Basis Future", "description": "Columbia Gulf Basis", "region": "south_central"},
    {"product": "CGM", "ice_product_id": "6590127", "product_name": "ANR SE (Louisiana) Basis Future", "description": "ANR SE-T Basis", "region": "south_central"},
    {"product": "TWB", "ice_product_id": "6590168", "product_name": "TETCO WLA Basis Future", "description": "Tetco WLA Basis", "region": "south_central"},
    {"product": "HXS", "ice_product_id": "6590137", "product_name": "HSC Basis Future", "description": "Houston Ship Channel Basis", "region": "south_central"},
    {"product": "WAH", "ice_product_id": "6590171", "product_name": "Waha Basis Future", "description": "Waha Basis", "region": "south_central"},
    {"product": "NTO", "ice_product_id": "6590143", "product_name": "NGPL TXOK Basis Future", "description": "NGPL TX/OK Basis", "region": "south_central"},
    {"product": "ALQ", "ice_product_id": "6590124", "product_name": "Algonquin Citygates Basis Future", "description": "Algonquin Citygates Basis", "region": "east"},
    {"product": "TMT", "ice_product_id": "6590161", "product_name": "TETCO M3 Basis Future", "description": "Tetco M3 Basis", "region": "east"},
    {"product": "T5B", "ice_product_id": "82270888", "product_name": "Transco Zone 5 South Basis Future", "description": "Transco Zone 5 South Basis", "region": "east"},
    {"product": "IZB", "ice_product_id": "21587547", "product_name": "Iroquois-Z2 Basis (Platts) Future", "description": "Iroquois Zone 2 Basis", "region": "east"},
    {"product": "TZS", "ice_product_id": "6590169", "product_name": "Transco Zone 6 (NY) Basis Future", "description": "Transco Zone 6 NY Basis", "region": "east"},
    {"product": "DOM", "ice_product_id": "6590133", "product_name": "Eastern Gas South Basis Future", "description": "Dominion South Basis", "region": "east"},
