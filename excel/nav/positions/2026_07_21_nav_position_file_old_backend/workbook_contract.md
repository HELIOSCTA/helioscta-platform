# Old Backend Workbook Contract

This old-backend workbook is macro-enabled and local-only. Git tracks the
extracted SQL, historical dbt-backed update script, and this contract; `.xlsm`
...
tables, or named ranges as part of a SQL-source migration or historical
comparison.
...
cd ..\..
.\excel\nav\positions\2026_07_21_nav_position_file_old_backend\update_workbook_queries.ps1
```

The script writes `marex_and_nav_position_file_2026_may_11_ref_tables_local.xlsm` by
...
```powershell
.\excel\nav\positions\2026_07_21_nav_position_file_old_backend\refresh_and_compare_workbooks.ps1
```
