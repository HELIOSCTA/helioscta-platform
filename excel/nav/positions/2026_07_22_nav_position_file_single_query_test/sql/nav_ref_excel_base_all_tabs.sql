...
select *
from FINAL
),  __dbt__cte__nav_ref_excel_sftp_metadata as (
with positions as (
...
order by
    ...
    strike_price,
    contract_yyyymm
),  __dbt__cte__nav_ref_excel_30_positions_grouped_latest as (
...
order by
    ...
    contract_yyyymmdd,
    marex_description
),  __dbt__cte__nav_ref_excel_gas_futures_pivot as (
with positions as (
    select * from __dbt__cte__nav_ref_excel_05_recent_positions_all_history
),
...
order by
    ...
    select * from __dbt__cte__nav_ref_excel_sftp_metadata
),

grouped_latest as (
    select * from __dbt__cte__nav_ref_excel_30_positions_grouped_latest
),
...
gas_futures_pivot as (
    select * from __dbt__cte__nav_ref_excel_gas_futures_pivot
),
