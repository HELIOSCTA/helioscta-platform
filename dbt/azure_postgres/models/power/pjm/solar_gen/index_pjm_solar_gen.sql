-- Source-table indexes for pjm.solar_gen.
--
...
create index concurrently if not exists idx_solar_gen_freshness
    on pjm.solar_gen (
...
create index concurrently if not exists idx_solar_gen_pk_lookup
    on pjm.solar_gen (
