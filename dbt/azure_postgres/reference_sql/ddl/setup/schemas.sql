...
CREATE SCHEMA IF NOT EXISTS caiso AUTHORIZATION helios_admin;
...
CREATE SCHEMA IF NOT EXISTS spp AUTHORIZATION helios_admin;
CREATE SCHEMA IF NOT EXISTS nyiso AUTHORIZATION helios_admin;
...
CREATE SCHEMA IF NOT EXISTS ice_python AUTHORIZATION helios_admin;
