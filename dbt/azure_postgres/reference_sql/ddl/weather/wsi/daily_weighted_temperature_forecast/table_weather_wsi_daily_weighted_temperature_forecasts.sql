-- Source-table DDL for weather.wsi_daily_weighted_temperature_forecasts.
--
...
--
-- Source system: WSI Trader GetModelForecast.
-- Source product: WEIGHTED_TEMPERATURE_FORECAST.
-- Grain:
...
CREATE TABLE IF NOT EXISTS weather.wsi_daily_weighted_temperature_forecasts (
    ...
    source_product_id VARCHAR NOT NULL DEFAULT 'WEIGHTED_TEMPERATURE_FORECAST',
