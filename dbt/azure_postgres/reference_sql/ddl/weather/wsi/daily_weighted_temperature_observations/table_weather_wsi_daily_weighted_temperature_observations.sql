-- Source-table DDL for weather.wsi_daily_weighted_temperature_observations.
--
...
-- Source product: HISTORICAL_WEIGHTED_TEMPERATURE.
-- Grain:
...
CREATE TABLE IF NOT EXISTS weather.wsi_daily_weighted_temperature_observations (
    source_product_id VARCHAR NOT NULL DEFAULT 'HISTORICAL_WEIGHTED_TEMPERATURE',
