-- Read-only validation SQL for CAISO Meteologica hourly forecasts.
...
latest_table AS (
    ...
    FROM meteologica.caiso_forecast_hourly
...
WHERE pipeline_name = 'caiso_meteologica_forecast_hourly'
...
WHERE dataset = 'caiso_meteologica_forecast_hourly'
ORDER BY created_at DESC
LIMIT 20;
