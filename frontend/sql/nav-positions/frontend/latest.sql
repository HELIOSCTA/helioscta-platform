...
--
-- This is a thin projection over the canonical v3 latest mart. Product,
...
select *
from FINAL
),  __dbt__cte__nav_v3_50_positions_latest as (
...
from FINAL
    ...
    select * from __dbt__cte__nav_v3_50_positions_latest
),
