...
-- Source dbt model: dbt/azure_postgres/models/pjm_da_model/pjm/rto_load_hourly/pjm_rto_load_hourly_history.sql
-- Source dbt compiled SQL: dbt\azure_postgres\target\compiled\helioscta_platform\models\pjm_da_model\pjm\rto_load_hourly\pjm_rto_load_hourly_history.sql
...
metered_source_rows as (
    select
        ...
        l.is_verified,
        l.updated_at
    from "helios_prod"."pjm"."hrl_load_metered" l
    cross join params p
...
prelim_source_rows as (
    select
        ...
        pld.updated_at
    from "helios_prod"."pjm"."hrl_load_prelim" pld
    cross join params p
